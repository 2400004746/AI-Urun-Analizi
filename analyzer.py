...
def translate_with_hf_subprocess(text: str, src_lang: str) -> str:
    ...
    try:
        ...
        script_path = os.path.join(os.path.dirname(__file__), "translator_hf.py")
        cmd = [sys.executable, script_path, in_path, out_path, src_lang]
...
def translate_if_needed(text: str) -> str:
    """
    Yorum Türkçe değilse, M2M100 çevirisini translator_hf.py ile yapar.
    - TR ise: direkt kullan
    - Diğer tüm dillerde: alt sürecin src_lang parametresine langdetect sonucu verilir.
    """
    try:
        lang = detect(text)
    except Exception:
    ...
    # ✅ SADECE BURAYA EKLE
    # langdetect -> M2M100 uyumlulaştırma
    lang_map = {
        "zh-cn": "zh",
        "zh-tw": "zh",
        "pt-br": "pt",
